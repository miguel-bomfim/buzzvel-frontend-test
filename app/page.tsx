...
import ViewDemoIcon from "./components/svg/ViewDemoIcon";
        ...
        <div className="flex flex-col gap-8 md:gap-20">
          <div className="flex flex-col md:gap-8 gap-6">
            ...
            <div className="flex gap-6 items-center">
              <button className="md:text-lg cursor-pointer py-3 md:px-8 px-6 bg-orange-600 text-white rounded-lg hover:bg-orange-500">Sign Up Now</button>
