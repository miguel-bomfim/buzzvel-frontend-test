		...
		<section className="flex gap-12 flex-col md:grid md:grid-cols-2 py-12 px-4 md:px-20 items-center font-sans"> 
            ...
            An&nbsp;
              ...
              app that makes it easier
					...
					<p className='md:hidden'>Sit elit feugiat turpis sed integer integer accumsan turpis. Sed suspendisse nec lorem mauris.
			...
			<div className="relative max-w-2xl w-full">
				...
				<div className="relative z-10">
					<div className="rounded-xl overflow-hidden shadow-lg">
						<Image src={videoPreviewPhoto} alt="App preview" className="w-full object-cover" />
						<div className="absolute inset-0 flex items-center justify-center">
							<button className="bg-white/80 p-3 rounded-full shadow-xl hover:scale-105 transition">
								<svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-black" viewBox="0 0 20 20" fill="currentColor">
									<path fillRule="evenodd" d="M6.5 5.5a1 1 0 011.538-.844l6 4a1 1 0 010 1.688l-6 4A1 1 0 016.5 13.5v-8z" clipRule="evenodd" />
								</svg>
							</button>
						</div>
					</div>
					...
					<div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
						<div className="bg-white p-4 rounded-lg shadow border-t-4 border-purple-400">
							...
							<p className="text-sm text-gray-600 mt-1">Egestas elit ut scelerisque ut eu sit vitae...</p>
							<button className="mt-2 text-blue-600 text-sm font-medium hover:underline">Take Lesson</button>
						</div>
						<div className="bg-white p-4 rounded-lg shadow border-t-4 border-blue-400">
							...
							<h4 className="font-semibold mt-1">Design for how people think</h4>
							<p className="text-sm text-gray-600 mt-1">Aliquam et euismod condimentum...</p>
							<button className="mt-2 text-blue-600 text-sm font-medium hover:underline">Take Lesson</button>
						</div>
						<div className="bg-white p-4 rounded-lg shadow border-t-4 border-green-400">
							...
							<h4 className="font-semibold mt-1">International & commercial law</h4>
							<p className="text-sm text-gray-600 mt-1">Molestie integer eu arcu mauris bibendum...</p>
							<button className="mt-2 text-blue-600 text-sm font-medium hover:underline">Take Lesson</button>
						</div>
					</div>
				</div>
